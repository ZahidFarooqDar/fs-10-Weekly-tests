package com.zahid.restaurant.model;
...
public class Restaurant {
    ...
    public Restaurant(String resto_name, String resto_address, int resto_number, String resto_speciality, int resto_totalstaff) {
